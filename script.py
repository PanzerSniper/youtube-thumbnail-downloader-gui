...
class ThumbnailDownloaderApp:
    ...
    def _configure_style(self):
        ...
        style.map(
            "TCombobox",
            fieldbackground=[("readonly", "#0d1016")],
            foreground=[("readonly", "#f5f7fa")],
            selectbackground=[("readonly", "#0d1016")],
            selectforeground=[("readonly", "#f5f7fa")],
            bordercolor=[("focus", "#5d8cff")]
        )
        self.root.option_add("*TCombobox*Listbox.background", "#0d1016")
        self.root.option_add("*TCombobox*Listbox.foreground", "#f5f7fa")
        self.root.option_add("*TCombobox*Listbox.selectBackground", "#5d8cff")
